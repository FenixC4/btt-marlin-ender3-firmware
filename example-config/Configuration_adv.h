...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-3/BigTreeTech SKR Mini E3 3.0 TEST"
...
#define INVERT_X_STEP_PIN LOW
#define INVERT_Y_STEP_PIN LOW
#define INVERT_Z_STEP_PIN LOW
#define INVERT_I_STEP_PIN LOW
#define INVERT_J_STEP_PIN LOW
#define INVERT_K_STEP_PIN LOW
#define INVERT_U_STEP_PIN LOW
#define INVERT_V_STEP_PIN LOW
#define INVERT_W_STEP_PIN LOW
#define INVERT_E_STEP_PIN LOW
